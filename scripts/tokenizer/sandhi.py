...
Rule(re.compile(r"(ி|உ|அ)\s*(போ|வா|இரு|உள்)")),

# -த்து/-ட்டு + auxiliary
Rule(re.compile(r"(த்து|ட்டு)\s*(கொள்|விடு|போ|ஆகு)")),

# -ஆன/-என்/-உம் adjectival/relativizer + noun
Rule(re.compile(r"(ஆன|என்|உம்)\s*([அஆஇஈஉஊஎஏஒஓஐஔஅ-ஹ])")),

# ---------------------------------------------------------------------
# I) Numeral + classifier/suffix
# ---------------------------------------------------------------------

Rule(re.compile(r"([௦-௯0-9]+)\s*(ஆம்(?: நாள்| ஆண்டு)?)")),
Rule(re.compile(r"([௦-௯0-9]+)\s*(ஐ)")),
